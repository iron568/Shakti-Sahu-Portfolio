...
import {
  ...
  FaGithubAlt,
  FaDatabase,
} from "react-icons/fa"; // Imported FaDatabase for standard SQL icon
import AnimatedBackground from "../components/AnimatedBackground";
  ...
  const projects = [
    ...
    },
    {
      ...
      tech: [
        { name: "React", icon: SiReact, color: "#61DAFB" },
        { name: "Node.js", icon: SiNodedotjs, color: "#339933" },
        { name: "SQL DB", icon: FaDatabase, color: "#47A248" }, // Fixed icon to standard FaDatabase instead of SiMongodb
      ],
      links: {
        live: "https://tenant-home.vercel.app",
        github: "https://github.com/shaktisahu/ecommerce",
            ...
            >
              ...
              <div className="flex gap-4">
                <motion.a
                  href={project.links.live}
                  target="_blank"
                  rel="noopener noreferrer" // Security fix added here
                  className="flex-1 py-4 bg-white text-black rounded-2xl font-black text-center flex items-center justify-center gap-2 group/btn relative overflow-hidden transition-all"
                  whileHover={{ scale: 1.02 }}
                >
                  <span className="relative z-10 flex items-center gap-2">
